...
It is also the automatic start page for version *{demo}* of Component B.
...
This page is used as the home page for the Antora Demo because it is assigned as the site `start_page` in the Demo site's playbook file [.path]_demo-site.yml_.
